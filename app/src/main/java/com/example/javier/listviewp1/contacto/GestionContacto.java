...
/**
 * Created by Javier on 14/10/2015.
 */
public class GestionContacto {
    public static List<Contacto> getLista(Context contexto){
        ArrayList<Contacto> contactos = (ArrayList<Contacto>) GestionContacto.getListaContactos(contexto);

        for(Contacto c : contactos){
            c.setTelefono((ArrayList<String>) GestionContacto.getListaTelefonos(contexto, c.getId()));
        }
